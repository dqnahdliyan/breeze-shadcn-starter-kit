...
export default function Welcome({ auth, laravelVersion, phpVersion }) {
    return (
        <>
            <Head title="Welcome" />
            <div className="relative min-h-screen bg-gradient-to-tr from-blue-300 to-indigo-300 sm:flex sm:justify-center sm:items-center bg-dots-darker dark:bg-dots-lighter dark:bg-gray-900 selection:bg-red-500 selection:text-white">
                <div className="z-50 flex items-center justify-end p-6 space-x-3 sm:fixed sm:top-0 sm:right-0 text-end">
                    <ThemeSwitch className="inline-flex items-center" />
                    {auth.user ? (
                        <Link
                            href={route("dashboard")}
                            className="font-semibold hover:text-zinc-500 focus:outline-none"
                        >
                            Dashboard
                        </Link>
                    ) : (
                ...
                <div className="p-6 mx-auto max-w-7xl lg:p-8">
                    <div className="flex justify-center">
                        <ApplicationLogo className="w-auto h-16 fill-red-500 " />
                    </div>
                    ...
                    <div className="flex justify-center px-6 mt-16 sm:items-center sm:justify-between">
                        <div className="text-sm text-center text-gray-500 dark:text-gray-400 sm:text-start">
                            <div className="flex items-center gap-4">
                                ...
                                >
                                    <svg
                                        ...
                                        viewBox="0 0 24 24"
                                        strokeWidth="1.5"
                                        className="w-5 h-5 -mt-px me-1 stroke-gray-400 dark:stroke-gray-600 group-hover:stroke-gray-600 dark:group-hover:stroke-gray-400"
                                    >
                                        <path
                                            strokeLinecap="round"
                                            strokeLinejoin="round"
                        ...
                        <div className="text-sm text-center text-gray-500 ms-4 dark:text-gray-400 sm:text-end sm:ms-0">
